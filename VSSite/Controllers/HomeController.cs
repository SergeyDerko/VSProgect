        ...
        public string DataSid()
        {
            using (Context context = new Context())
            {
                if (!context.Businesses.Any())
                {
                    ...
                    {
                        Picture = "marker-study.png",
                        RubName = "Навчання",
                        RubNameEu = "Teaching"
                    });
                    context.UsefulRubricses.Add(new UsefulRubrics
                    {
                        Picture = "marker-sport.png",
                        RubName = "Спорт",
                        RubNameEu = "Sport"
                    });
                    context.UsefulRubricses.Add(new UsefulRubrics
                    {
                        Picture = "marker-juralhelp.png",
                        RubName = "Юридична підтримка",
                        RubNameEu = "Legal support"
                    });
                    context.UsefulRubricses.Add(new UsefulRubrics
                    {
                        Picture = "marker-centers.png",
                        RubName = "Центри ветеранів",
                        RubNameEu = "Centers of Veterans"
                    });
                    context.UsefulRubricses.Add(new UsefulRubrics
                    {
                        Picture = "marker-psyhohelp.png",
                        RubName = "Психологічна підтримка",
                        RubNameEu = "Psychological support"
                    });
                    context.SaveChanges();
                    ...
                    var user = new ApplicationUser { Email = "veteranoservice@gmail.com", UserName = "veteranoservice@gmail.com" };
                    var result = manager.Create(user, "veterano17012017");
